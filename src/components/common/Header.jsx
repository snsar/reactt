...
function Header() {
  ...
  return (
    <header className="bg-base-100 shadow-lg fixed top-0 left-0 right-0 z-50">
      <div className="navbar container mx-auto">
        ...
        <div className="navbar-center">
          <Link to="/products" className="btn btn-ghost">Sản phẩm</Link>
        </div>
          ...
          {user ? (
            <div className="dropdown dropdown-end ml-4">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                ...
                {user.listRoles?.includes('ROLE_ADMIN') && (
            ...
            <Link to="/login" className="btn btn-primary ml-4">Đăng nhập</Link>
          )}
        </div>
      </div>
    </header>
